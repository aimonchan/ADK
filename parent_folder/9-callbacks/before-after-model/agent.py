...
def before_model_callback(
    ...
    It filters in appropriate content and logs request info.
    ...
    #Check for inappripriate content
    if last_user_message and "sucks" in last_user_message.lower():
        ...
        return LlmResponse(
            content=types.Content(
                ...
                parts= [
                    types.Part(
                        text="I cannot respond to messages containing inappripriate language."
...
def after_model_callback(
    ...
    """
    Simple callback that replace negative words with more positive alternatives.
