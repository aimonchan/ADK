...
stock_analyst = Agent(
    ...
    instruction = """
    You are a helpful stock market assistant that helps users track their stock of interest.

    When asked about stock prices:
    1. Use the get_stock_price tool to fetch the lates price for the requested stock(s)
